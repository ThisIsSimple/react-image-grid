...
function Ne(e, n, r, o) {
  ...
  if (E(e)) {
    ...
    var u = e(n);
    return reactIs.isElement(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), Ne(u, n, r, o);
  }
  ...
  var A,
    ...
    return function (e, t, n, r) {
      ...
      var m = function (e, t, n) {
        ...
        return react.useDebugValue(s), !t && r && r(s), s;
...
var Ye = function (e) {
  return function e(t, r, o) {
    if (void 0 === o && (o = w), !reactIs.isValidElementType(r)) return D(1, String(r));
...
const Container = Ye.div`
  ...
  ${props => !props.isHorizontal && props.count === 3 && `grid-template-columns: 2fr 1fr; grid-template-rows: repeat(2, 1fr);`}
  ${props => !props.isHorizontal && props.count >= 4 && `grid-template-columns: 2fr 1fr; grid-template-rows: repeat(3, 1fr);`}
  gap: 0.2rem;
  ${ImgCell}:nth-child(1) {
    grid-column-start: 1;
    grid-row-start: 1;
...
const ImageGrid = ({
  ...
  return imageLoaded && /*#__PURE__*/react.createElement(Container, {
    isHorizontal: isHorizontal,
    count: count,
    className: className
  }, images.map((image, index) => index <= 3 && /*#__PURE__*/react.createElement(ImgCell, {
    key: image,
    className: "shadow"
